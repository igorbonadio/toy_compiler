...
Likely is a language to specify probabilistic models. But it is not just that! In fact Likely is a full language that will help you to build sequence analysis tools.
